...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // 应用字体配置到代码
  applyFontConfig: (projectDir, configs) => ipcRenderer.invoke('apply-font-config', projectDir, configs),
  ...
  // 扫描项目中的@font-tool注释
  scanFontToolComments: (projectDir) => ipcRenderer.invoke('scan-font-tool-comments', projectDir),
